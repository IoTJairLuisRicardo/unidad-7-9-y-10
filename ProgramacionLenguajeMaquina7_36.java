...
public class ProgramacionLenguajeMaquina7_36 {

	public static void main(String[] args) 
	{
        
		System.out.println("           Programa SIMPLETROMc\n"
	    		+          "A continuacion ingresaras dos numeros y se sumaran\n"
	    		+          "      seguido de eso calcularemos la suma.\n");
	    ...
	    do
	    {
		    ...
		    opc=entrada1.nextInt();
			    ...
			    if(opc==numero[5])
			    {
			    	double d;
			    	d=ubicacion[9]/10;
			    	System.out.println("Lasuma es: %d"+d);
			   ...
			   //////////
			    ...
			    if(opc==numero[9])
			    {
			    	System.out.println("Lasuma es: "+ubicacion[9]);
			    }
		
	    }while(opc!=numero[6]);
	
	
    	System.out.println("\n\n     El Programa se DETUBO.");
